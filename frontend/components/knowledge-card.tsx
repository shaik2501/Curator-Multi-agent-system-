...
export function KnowledgeCard({ entry }: { entry: KnowledgeEntry }) {
  ...
  return (
    <div className="glass-card rounded-xl p-3">
      ...
      {imageSrc && (
        <div className="relative mb-2 overflow-hidden rounded-md bg-surface-container-lowest min-h-[14rem]">
          {imgStatus === "error" ? (
            <div className="flex h-56 flex-col items-center justify-center gap-1 text-on-surface-variant/50">
